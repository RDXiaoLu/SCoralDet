...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/mnt/hdd/yuanhui/ultralytics-main/ultralytics/results/Mamba_YOLO_T_AFGC/weights/best.pt', help='trained weights path')
